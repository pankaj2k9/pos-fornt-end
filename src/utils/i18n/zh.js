const zh = {
  ...
  'app.lbl.syncSuccess': '已成功同步',
  'app.lbl.syncFailed': '无法同步',
  'app.lbl.notSynced': '不同步',
  'app.lbl.syncing': '当前正在同步. . .',
  ...
  'app.button.logoutCashier': '退出',
  'app.button.changeCashier': ' 更换员工',
  'app.button.clickHere': '点击这里',
  'app.button.exportToText': '导出到文本文件',
  'app.button.generate': '生成',
  'app.button.offline': '离线',
  'app.button.online': '线上',
  ...
  'app.button.outletStock': '店面存货',
  'app.button.repRef': '重印/退款',
  'app.button.addOD': '整体折价',
  'app.button.cash': '现金',
  'app.button.doublePoints': ' 双倍几分',
  'app.button.useOC': 'odbo 硬币',
  'app.button.voucher': '礼券',
  ...
  'app.page.reports.odbo': 'The odbo 硬币',
